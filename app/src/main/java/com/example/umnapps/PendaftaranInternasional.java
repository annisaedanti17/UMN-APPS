...
public class PendaftaranInternasional extends AppCompatActivity {
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pendaftaran_internasional);
        ...
        if (navHome != null) {
            navHome.setOnClickListener(v -> {
                startActivity(new Intent(PendaftaranInternasional.this, HomeActivity.class));
            });
        }
        ...
        if (navProfil != null) {
            navProfil.setOnClickListener(v -> {
                startActivity(new Intent(PendaftaranInternasional.this, ProfilActivity.class));
            });
        }
        ...
        if (navFakultas != null) {
            navFakultas.setOnClickListener(v -> {
                startActivity(new Intent(PendaftaranInternasional.this, FakultasActivity.class));
            });
        }
        ...
        if (navFasilitas != null) {
            navFasilitas.setOnClickListener(v -> {
                startActivity(new Intent(PendaftaranInternasional.this, FasilitasActivity.class));
            });
        }
